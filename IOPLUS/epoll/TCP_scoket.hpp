...
namespace TCP
{
    ...
    public:
        ...
        static void Bind(int sockfd, uint16_t port, const std::string &ip = "0.0.0.0")
        {
            // 2. 绑定套接字
        ...
        static bool Connect(int socket, const std::string &server_ip, const uint16_t &server_port)
        {
            //请求连接
            sockaddr_in server;
    ...
    public:
        static const int gbacklog;
    };

    const int TcpSocket::gbacklog = 10;
